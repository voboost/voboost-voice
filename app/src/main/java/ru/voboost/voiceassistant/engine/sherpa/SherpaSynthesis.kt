 ...
 */
class SherpaSynthesis(private val context: Context,
                      private val modelPath: String,
                      private val speakerId: Int) : ISpeechSynthesis {
    ...
    private suspend fun playAudioData(audio: FloatArray) {
        withContext(Dispatchers.IO) {
            ...
            val audioFormat = AudioFormat.Builder().setSampleRate(sampleRate)
