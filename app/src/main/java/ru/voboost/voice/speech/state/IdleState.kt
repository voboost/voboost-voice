...
/**
 * —осто€ние: ќжидание ключевого слова
 *
 * Ћогика:
 * 1. —крыть анимацию, восстановить громкость
 * 2. ∆дЄм KeywordDetected из SpeechRecognizer
...
class IdleState(private val context: StateContext) : BaseState() {
    ...
    override suspend fun execute() {
        ...
        try {
            ...
            // ∆дЄм ключевое слово из SharedFlow
            val result =
            ...
            //  лючевое слово получено > ACTIVATED
