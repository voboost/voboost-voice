...
import ru.voboost.voice.executor.handlers.aidl.airconditioner.AirConditionerSetTempHandler
import ru.voboost.voice.executor.handlers.aidl.airconditioner.AirConditionerTempOffsetHandler
import ru.voboost.voice.executor.handlers.aidl.drivingmode.ComfortDrivingModeHandler
import ru.voboost.voice.executor.handlers.aidl.drivingmode.EcoDrivingModeHandler
import ru.voboost.voice.executor.handlers.aidl.drivingmode.IndividualDrivingModeHandler
import ru.voboost.voice.executor.handlers.aidl.drivingmode.OffRoadDrivingModeHandler
import ru.voboost.voice.executor.handlers.aidl.drivingmode.SnowDrivingModeHandler
import ru.voboost.voice.executor.handlers.aidl.drivingmode.SportDrivingModeHandler
import ru.voboost.voice.executor.handlers.aidl.scuttle.ChargportOpenHandler
import ru.voboost.voice.executor.handlers.aidl.scuttle.FuelTankOpenHandler
import ru.voboost.voice.executor.handlers.aidl.smartmode.ChildSmartModeHandler
import ru.voboost.voice.executor.handlers.aidl.smartmode.LeisureSmartModeHandler
import ru.voboost.voice.executor.handlers.aidl.smartmode.RomanticSmartModeHandler
import ru.voboost.voice.executor.handlers.aidl.smartmode.WashSmartModeHandler
import ru.voboost.voice.executor.handlers.aidl.socmode.ElectroSOCModeHandler
import ru.voboost.voice.executor.handlers.aidl.socmode.HybridSOCModeHandler
import ru.voboost.voice.executor.handlers.aidl.socmode.SaveSOCModeHandler
import ru.voboost.voice.executor.handlers.aidl.window.WindowCloseAllHandler
import ru.voboost.voice.executor.handlers.aidl.window.WindowCloseDriverHandler
import ru.voboost.voice.executor.handlers.aidl.window.WindowOpenAllHandler
import ru.voboost.voice.executor.handlers.aidl.window.WindowOpenDriverHandler
import ru.voboost.voice.executor.handlers.intent.phone.PhoneCallContactIntentHandler
