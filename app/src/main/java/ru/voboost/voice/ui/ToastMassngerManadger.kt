...
class ToastMessengerManager(context: Context,
    ...
    fun show(message: String) {
        ...
        // 🔥 Прямое присваивание полям с префиксом 'm'
        val event = QGBusEvent().apply {
            mEventType = EVENT_TYPE
            mSource = componentName
            mData = bundle
            mDestination = DESTINATION
            isSticky = false  // Этот метод есть в системном классе
            mPriority = QGBusEvent.EVENT_NORMAL_PRIORITY  // опционально
        }
